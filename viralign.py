# -*- coding: utf-8 -*-
"""virus-align-idx-sorting.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qkyGq68lzPnAju8ZVH-QSaJ1AmzVqBKH
"""
...
# https://rvdb.dbi.udel.edu/download/U-RVDBv17.0.sqlite.db.gz

sqlite_file = 'U-RVDBv17.0.sqlite'
!wget https://rvdb.dbi.udel.edu/download/{sqlite_file}.db.gz
!gunzip {sqlite_file}.db.gz

import sys
import csv

# sequence name, sequence length, # mapped read-segments and # unmapped read-segments
idxstats_filename = 'leila_computed_P60496_2.virus.bam.sorted.idxstats'
...
import sqlite3
conn = sqlite3.connect(f'{sqlite_file}.db')

# locus_name = 'DQ112136.1'
locus_name = 'AB017630.1'
...
for index in range(len(sortedlist_filtered)):
  ...
  # only for colab progress
  out.update(progress(((index + 1) * 100 / len(sortedlist_filtered)), 100))

  # print('Finished row', index, 'of', len(sortedlist_filtered))
